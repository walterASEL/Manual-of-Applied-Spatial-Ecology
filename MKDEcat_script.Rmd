...
writeRaster(FLnlcd, filename="data/FLnlcd.asc", filetype="AAIGrid", gdal=c("DECIMAL_PRECISION=2"), datatype="FLT8S", NAflag = -9999, overwrite=TRUE)

FLnlcd.asc <- rast("data/FLnlcd.asc")

FLnlcd.spixdf <- asc2spixdf(FLnlcd.asc) # Function from adehabitat to convert to SpatialPixelDataFrame
